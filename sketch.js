...
function preload() {
   ...
   jerryTeasing = loadImage("images/jerryThree.png")
    tomSitting = loadImage("images/tomOne.png");
    tomWalking = loadImage("images/tomTwo.png")
    jerryeatingCheese = loadImage("images/jerryOne.png")
}
